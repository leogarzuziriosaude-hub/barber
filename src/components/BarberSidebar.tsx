...
export default function BarberSidebar() {
  ...
  return (
    <>
      ...
      <aside className={`mobile-sidebar fixed right-0 top-0 z-[100] flex w-72 flex-col border-l border-[#eee2c9]/10 bg-[#211f1c] p-5 text-[#f3ead8] transition-transform duration-300 lg:left-0 lg:right-auto lg:translate-x-0 lg:border-l-0 lg:border-r ${aberto ? "translate-x-0" : "translate-x-full"}`}>
